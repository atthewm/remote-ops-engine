 ...
 */
export function isInCooldown(fingerprint, cooldownMinutes) {
 ...
 */
export function recordFired(fingerprint, ruleId) {
 ...
 */
export function generateFingerprint(ruleId, storeId, dateWindow, discriminator) {
 ...
 */
export function purgeExpired(maxAgeDays = 7) {
