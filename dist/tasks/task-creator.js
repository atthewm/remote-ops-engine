 ...
 */
export async function createTaskForAlert(alert, planId, config, channelInfo) {
    ...
    try {
        const taskResult = await createPlannerTask(planId, title, assigneeId, dueDate, notes);
        if (!taskResult) {
 ...
 */
export async function createTasksForAlerts(alerts, planId, config, channelInfoByAlert) {
 ...
 */
function resolveAssigneeId(ownerName, config) {
 ...
 */
async function postTaskCreatedNotice(alert, taskId, taskUrl, channelInfo) {
    try {
...
//# sourceMappingURL=task-creator.js.map